...
import {MESSAGES, openPage, URLS} from "../../helper/ui-helper";
...
class LoginPage extends BasePage {
  ...
  get alertMessage() {
    ...
    async assertLoginPageIsVisible() {  // is used in login method
    ...
    async assertLoginPageAlertMessageIsVisible() {
        ...
        await expect(this.alertMessage).toHaveTextContaining(MESSAGES.LOGIN_ALERT_MESSAGE);
    };
}
