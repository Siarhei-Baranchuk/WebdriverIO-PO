export const config = {
  ...
  //
  // The tests are defined as an array of spec files (optionally using wildcards
  // that will be expanded). The test for each spec file will be run in a separate
  // worker process. In order to have a group of spec files run in the same worker
  // process simply enclose them in an array within the tests array.
  //
   ...
   * @param  {[type]} tests    tests to be run in the worker process
  ...
  before: function (capabilities, specs) {
    browser.addCommand("waitAndClickOn", async (element) => {
    ...
    browser.addCommand("typeTextIntoField", async (element, text) => {
      await element.waitForDisplayed();
